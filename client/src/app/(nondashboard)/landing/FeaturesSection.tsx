        ...
        >
            <div className='max-w-4xl  xl:max-w-6xl mx-auto'>
                <motion.h2 variants={itemVariants}
                    className='text-3xl font-bold text-center mb-12 w-full sm:w'>
                    Quickly find the fome you want using our effetive search filters!
                </motion.h2>
                    ...
                    {[0,1,2].map((index) => (
                        <motion.div key={index} variants={itemVariants}>
                            <FeatureCard imageSrc={`/landing-search${3 - index}.png`}
                                ...
                                description={["Discover the best renatl options with user reviews and ratings",
